...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/admin/alibaba-codes": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/alibabacodehandler.ListAlibabaCodeResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create Alibaba code input",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/alibabacodehandler.CreateAlibabaCodeRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/alibabacodehandler.CreateAlibabaCodeResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/alibabacodehandler.GetAlibabaCodeResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/admin/alibaba-codes/{id}/assign": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "Assign Alibaba code input",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/alibabacodehandler.AssignAlibabaCodeRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/alibabacodehandler.AssignAlibabaCodeResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/admin/users/today-birthdate": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/admin/users/today-cooperation-start-date": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/admin/users/{id}/birthdate": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "Update Birthdate",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/userhandler.UpdateUserBirthdateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/admin/users/{id}/cooperation-start-date": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "Update Cooperation Start Date",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/userhandler.UpdateUserCooperationStartDateRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "alibabacodehandler.AlibabaCodeListData": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/contract.AlibabaCode"
                    }
                },
                "total": {
                    "type": "integer"
        ...
        "alibabacodehandler.AssignAlibabaCodeRequest": {
            "type": "object",
            "required": [
                "user_id"
            ],
        ...
        "alibabacodehandler.AssignAlibabaCodeResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/contract.AlibabaCode"
        ...
        "alibabacodehandler.CreateAlibabaCodeRequest": {
            "type": "object",
            "required": [
                "code",
                "type"
        ...
        "alibabacodehandler.CreateAlibabaCodeResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/contract.AlibabaCode"
        ...
        "alibabacodehandler.GetAlibabaCodeResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/contract.AlibabaCode"
        ...
        "alibabacodehandler.ListAlibabaCodeResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/alibabacodehandler.AlibabaCodeListData"
                },
                "message": {
                    "type": "string"
                },
        ...
        "contract.Resume": {
            ...
            "properties": {
                ...
                "user": {
                    "$ref": "#/definitions/contract.ResumeUser"
                },
                "user_id": {
                    "type": "integer"
                }
        ...
        "userhandler.UpdateUserBirthdateRequest": {
            "type": "object",
            "required": [
                "birthdate"
            ],
        ...
        "userhandler.UpdateUserCooperationStartDateRequest": {
            "type": "object",
            "required": [
                "cooperation_start_date"
            ],

...
const (
	// Label holds the string label denoting the requestmeta type in the database.
	Label = "request_meta"
	...
	EdgeRequest = "request"
	// Table holds the table name of the requestmeta in the database.
	Table = "request_meta"
	// RequestTable is the table that holds the request relation/edge.
	RequestTable = "request_meta"
...
// Columns holds all SQL columns for requestmeta fields.
var Columns = []string{
	FieldID,
	FieldRequestID,
	FieldKey,
...
// OrderOption defines the ordering options for the RequestMeta queries.

...
func (au *AlbumUpdate) SetURL(s string) *AlbumUpdate {
	au.mutation.SetURL(s)
	return au
}

// SetNillableURL sets the "url" field if the given value is not nil.
func (au *AlbumUpdate) SetNillableURL(s *string) *AlbumUpdate {
	if s != nil {
		au.SetURL(*s)
	}
	return au
...
func (au *AlbumUpdate) SetCaption(s string) *AlbumUpdate {
	au.mutation.SetCaption(s)
	return au
}

// SetNillableCaption sets the "caption" field if the given value is not nil.
func (au *AlbumUpdate) SetNillableCaption(s *string) *AlbumUpdate {
	if s != nil {
		au.SetCaption(*s)
	}
	return au
...
func (au *AlbumUpdate) ClearCaption() *AlbumUpdate {
	au.mutation.ClearCaption()
	return au
}
...
func (au *AlbumUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := au.mutation.Caption(); ok {
...
// SetURL sets the "url" field.
func (auo *AlbumUpdateOne) SetURL(s string) *AlbumUpdateOne {
	auo.mutation.SetURL(s)
	return auo
}

// SetNillableURL sets the "url" field if the given value is not nil.
func (auo *AlbumUpdateOne) SetNillableURL(s *string) *AlbumUpdateOne {
	if s != nil {
		auo.SetURL(*s)
	}
	return auo
...
// SetCaption sets the "caption" field.
func (auo *AlbumUpdateOne) SetCaption(s string) *AlbumUpdateOne {
	auo.mutation.SetCaption(s)
	return auo
}

// SetNillableCaption sets the "caption" field if the given value is not nil.
func (auo *AlbumUpdateOne) SetNillableCaption(s *string) *AlbumUpdateOne {
	if s != nil {
		auo.SetCaption(*s)
	}
	return auo
...
func (auo *AlbumUpdateOne) sqlSave(ctx context.Context) (_node *Album, err error) {
	...
	if value, ok := auo.mutation.Caption(); ok {
		_spec.SetField(album.FieldCaption, field.TypeString, value)
	}
